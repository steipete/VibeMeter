...
struct SettingsView: View {
    ...
    private func saveSettings() {
        ...
        LoggingService.info(
            "Settings saved. Warning: \(settingsManager.warningLimitUSD) USD, " +
                "Upper: \(settingsManager.upperLimitUSD) USD",
            category: .settings
        )
    }
...
struct SettingsView_Previews: PreviewProvider {
    static var previews: some View {
        let previewSettings = SettingsManager(
            userDefaults: UserDefaults(suiteName: "previewSettings") ?? UserDefaults.standard
        )
