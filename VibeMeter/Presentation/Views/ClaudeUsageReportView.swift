...
struct ClaudeUsageReportView: View {
    ...
    private var dailyTableView: some View {
    ...
    private var projectTableView: some View {
    ...
    @ViewBuilder
    private var costEmojiView: some View {
    ...
    @ViewBuilder
    private var toolbarAutomaticItems: some View {
        // View mode picker
    ...
    @ViewBuilder
    private var toolbarPrimaryItems: some View {
