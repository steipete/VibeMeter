...
/// Manages status bar menu behavior, providing both left-click popover and right-click context menu functionality.
///
/// This manager centralizes all menu-related logic for the status bar, handling the creation and display
/// of both the main SwiftUI interface (left-click) and native context menu (right-click).
@MainActor
