...
final class StatusBarDisplayManager {
    ...
    private func shouldUpdateTooltipAndAccessibility(from lastState: DisplayState?, to currentState: DisplayState) -> Bool {
        return lastState?.isLoggedIn != currentState.isLoggedIn ||
               lastState?.hasData != currentState.hasData ||
