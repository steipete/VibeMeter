...
fileprivate struct QueryItemTestCase: Sendable {
    let baseURL: String
...
fileprivate struct EncodingTestCase: Sendable {
    let baseURL: String
...
struct URLQueryItemsTests {
    ...
    struct Basic {
        ...
        func nilValuesInQueryItems(name: String, value: String?, description: String) {
            // Given
    ...
    struct Advanced {
        ...
        func queryPreservationWithComplexURLs() {
            ...
            // Then
            #expect(result.absoluteString == "https://api.example.com:8443/v2/users/123/posts?sort=date&order=desc&filter=published&limit=10#comments")
    ...
    struct RealWorld {
        ...
        func apiPaginationParameters() {
            ...
            // Then
            #expect(result.absoluteString == "https://api.example.com/users?page=2&per_page=50&sort=created_at&order=desc")
        }
        ...
        func oauthRedirectURI() {
            ...
            // Then
            #expect(result.absoluteString == "https://app.example.com/auth/callback?code=abc123xyz&state=random-state-12345&scope=read%20write")
        }
        ...
        func searchWithFilters() {
            ...
            // Then
            let expectedURL = "https://shop.example.com/products?q=laptop&category=electronics&min_price=500&max_price=1500&in_stock=true"
