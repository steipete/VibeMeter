...
final class CurrencyConversionHelperTests: XCTestCase {
    ...
    func testFormatAmount_WithInfiniteAmount() {
        ...
        // When
        let result = CurrencyConversionHelper.formatAmount(infiniteAmount, currencySymbol: currencySymbol, locale: locale)
    ...
    func testCurrencyConversionHelper_IsMainActor() {
        // Then
        XCTAssertTrue(type(of: CurrencyConversionHelper.self) is any MainActor.Type, "CurrencyConversionHelper should be MainActor")
    }
