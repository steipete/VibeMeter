...
struct TiktokenTests {
    ...
    func specialTokenEncoding() throws {
        let tiktoken = try Tiktoken(encoding: .o200k_base)
    ...
    func multilingualWithO200k() throws {
        let tiktoken = try Tiktoken(encoding: .o200k_base)
    ...
    func extremelyLongStrings() throws {
        let tiktoken = try Tiktoken(encoding: .o200k_base)
    ...
    func specialTokenEdgeCases() throws {
        let tiktoken = try Tiktoken(encoding: .o200k_base)
    ...
    func batchEdgeCases() throws {
        ...
        let largeBatch = (0 ..< 100).map { i in
            switch i % 5 {
            case 0: "Short"
            case 1: "A medium length string with some words"
            case 2: String(repeating: "Long ", count: 50)
            case 3: "Special <|endoftext|> tokens"
            case 4: "Unicode: 你好世界 🌍"
            default: "Default"
            }
        }
    ...
    func concurrentEncodingSafety() throws {
        let tiktoken = try Tiktoken(encoding: .o200k_base)
    ...
    func tokenCountAccuracy() throws {
        let tiktoken = try Tiktoken(encoding: .o200k_base)
    ...
    func decodeInvalidTokens() throws {
        let tiktoken = try Tiktoken(encoding: .o200k_base)
