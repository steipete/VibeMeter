...
fileprivate struct ColorTestCase: Sendable {
    let progress: Double
...
fileprivate struct SpendingScenario: Sendable {
    let progress: Double
    let description: String
    let expectedColor: Color
}

fileprivate struct WarningLevelTestCase: Sendable {
    let progress: Double
...
struct ProgressColorTests {
    ...
    struct EdgeCases {
        ...
        func specialFloatValues(progress: Double, expectedColor: Color, description: String) {
            // When
            let color = Color.progressColor(for: progress)
    ...
    struct WarningLevels {
        fileprivate static let warningLevelCases: [WarningLevelTestCase] = [
            ...
            WarningLevelTestCase(progress: 0.49, expectedLevel: "safe", expectedColor: .progressSafe, description: "Just below halfway"),
            
            // Caution zone
            WarningLevelTestCase(progress: 0.5, expectedLevel: "caution", expectedColor: .progressCaution, description: "Halfway point"),
            WarningLevelTestCase(progress: 0.6, expectedLevel: "caution", expectedColor: .progressCaution, description: "60% of budget"),
            WarningLevelTestCase(progress: 0.74, expectedLevel: "caution", expectedColor: .progressCaution, description: "Just below warning"),
            
            // Warning zone
            WarningLevelTestCase(progress: 0.75, expectedLevel: "warning", expectedColor: .progressWarning, description: "Warning threshold"),
            WarningLevelTestCase(progress: 0.8, expectedLevel: "warning", expectedColor: .progressWarning, description: "80% of budget"),
            WarningLevelTestCase(progress: 0.89, expectedLevel: "warning", expectedColor: .progressWarning, description: "Just below danger"),
            
            // Danger zone
            WarningLevelTestCase(progress: 0.9, expectedLevel: "danger", expectedColor: .progressDanger, description: "Danger threshold"),
            WarningLevelTestCase(progress: 1.0, expectedLevel: "danger", expectedColor: .progressDanger, description: "At limit"),
            WarningLevelTestCase(progress: 1.5, expectedLevel: "danger", expectedColor: .progressDanger, description: "Over budget")
        ]
        ...
        private func warningLevel(for progress: Double) -> String {
            switch progress {
            case ..<0.5: return "safe"
            case 0.5..<0.75: return "caution"
