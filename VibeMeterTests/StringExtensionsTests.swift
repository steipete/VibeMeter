...
final class StringExtensionsTests: XCTestCase {
    ...
    func testTruncated_VeryLongString_PerformanceTest() {
        // Given
        let longString = String(repeating: "b", count: 100000)
        let length = 50
    ...
    func testTruncated_ErrorMessage_ForNotification() {
        // Given
        let errorMessage = "Authentication failed: The provided API key is invalid or has expired. Please check your credentials."
        let maxLength = 50
